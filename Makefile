...
.PHONY: help test race fmt vet lint security check deps clean build install tools fuzz fuzz-long fuzz-path vulncheck
.DEFAULT_GOAL := help
...
security: gosec vulncheck ## Run security checks
